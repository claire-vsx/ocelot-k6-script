 ...
 * 編碼 Socket.IO 事件
 */
export function encodeEvent(namespace: string, eventName: string, data: unknown): string {
 ...
 * 連線到 namespace
 */
export function encodeConnect(namespace: string, auth: Record<string, unknown> = {}): string {
